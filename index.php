...
<div class="bg-image image-fluid" style="background-image: url('images/bgimage.jpg'); height: 400px;">
    <div class="mask w-100 h-100 d-flex flex-column justify-content-center align-items-center"
        ...
        <button type="button" class="btn btn-outline-light" data-bs-toggle="modal" data-bs-target="#myModal">Book
            Now</button>
        <div class="modal" id="myModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body text-center text-primary">
                        <b>You can't Book our services without SignIn.</b>
                        <button type="button" class="ms-3 btn-close" data-bs-dismiss="modal"></button>
                        <a class="btn btn-outline-primary mt-4" href="customer/signin.php">SignIn/Register</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid mt-4 mb-4">
    <div class="row">
        <div class="col-md-6 d-flex flex-column justify-content-center text-center align-items-center"
            style="color: #4CC6DA;">
            <h2>About Us</h2>
            <p class="m-4" style="color: #4CC6DA;">Our mission at Magic Cleaning Group is simple: to provide
            ...
            <a class="btn btn-lg btn-outline-light" style="border-color: #4CC6DA;">Learn More</a>
        </div>
        <div class="col-md-6">
...
<div style="background-color: #A9EBFF">
    <div class="container" style="background-color: #A9EBFF">
        <div class="row">
...
<div class="container-fluid mt-4 mb-4">
    <div class="row">
        <div class="col-md-6 d-flex flex-column justify-content-center text-center align-items-center">
            ...
            <a href="contactus.php" class="btn btn-lg btn-outline-dark">Get in Touch</a>
        </div>
        <div class="col-md-6">
