<?php
    ...
    if($_SESSION["username"] == 'admin')
    {
        ...
        {
            $del = $_GET['delete'];
            $delquery = "DELETE FROM email WHERE id = '$del' ";
    ...
    <div class="row vh-100">
        <div class="col-md-2" style="background-color:#1b395f;">
            ...
            <ul class="nav nav-pills flex-column">"
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="messages.php"><span
                ...
                <div class="justify-content-center">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                    <a class="btn btn-danger" href="messages.php?delete=<?php echo $row['id']; ?>">Delete</a>
                             </td>
