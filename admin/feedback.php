<?php
    ...
    if($_SESSION["username"] == 'admin')
    {
        ...
        {
            $del = $_GET['delete'];
            $delquery = "UPDATE `customer` SET `feedback`='NULL'  WHERE id = '$del' ";
    ...
    <div class="row vh-100">
        <div class="col-md-2" style="background-color:#1b395f;">
            ...
            <ul class="nav nav-pills flex-column">"
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="feedback.php"><span
                ...
                <div class="justify-content-center">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                    <a class="btn btn-danger" href="feedback.php?delete=<?php echo $row['id']; ?>">Delete</a>
                             </td>
