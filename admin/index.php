        ...
        <div class="col-md-4">
           <a href="index.php"><img class="justify-content-center img-fluid" src="../images/logo1.png" alt="logo"></a>
            <div class="card p-4" style="border-radius: 1rem; background-color: #e5d6fa;" >
                <h4 class="text-center"><i class="fa fa-user"></i> LOGIN</h4>
                <p class="text-center" style="color: black;">Enter your Username and Password to enter Admin Panel</p>
                <form action="" method="POST">
                        <label for="username" class="form-label"><i class="fa fa-user-circle-o"></i> Username</label>
                        <input type="text" class="form-control" id="username" name="Txtusername" placeholder="Username" required>
                        <label for="password" class=" mt-2 form-label"><i class="fa fa-key"></i> Password</label>
                ...
                <div class="card-footer text-center mt-4">
                    <p style="color: black;">this panel is just for admin to control the website data. </p>
                </div>
            </div>
        </div>
        <div class="col-md-4"></div>
