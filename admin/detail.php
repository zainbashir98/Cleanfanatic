<?php
    ...
    {
            $detail = $_GET['detail'];
            $output2 = "SELECT * FROM `staff` WHERE id = '$detail';";
    ...
    <div class="row vh-100">
        ...
        <div class="col-md-10">
            <div id="content" class="p-4 p-md-5 pt-5">
                <a class="btn btn-dark mb-5" href="staff.php">BACK</a>
                <h2 class="mb-4">Member Detail</h2>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <h2><b>Status</b></h2>
                        <span
                            class="<?php if($data['status'] == "Active") {echo "badge bg-success";}else{echo "badge bg-danger";}?> rounded-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <h2><?php echo $data['dob']; ?></h2>
                        <h2><b>Account Password</b></h2>
                        <h2><?php echo $data['password']; ?></h2>
                    </div>
                </div>
            </div>
        </div>
